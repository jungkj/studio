...
// Global cursor component that follows mouse everywhere
export const GlobalFollowingPointer = ({ 
  cursorImage = "/icons/pointer_reg.png"
}: { 
  cursorImage?: string 
}) => {
  ...
  return (
    ...
    >
      <img 
        src={cursorImage} 
        alt="cursor" 
        className="w-8 h-8 -translate-x-1 -translate-y-1"
        style={{
